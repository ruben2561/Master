...
def process_point_optimized(time_difference_hours, pv_power_values, power_usage_values, offtake_price_values, injection_price_values, soc_value, battery):
...
def process_data_optimized(data_points, battery):
    for i in range(len(data_points) - 1):
        ...
        if time_value and next_time:
            ...
            grid_injection, grid_offtake, charge_value, discharge_value = process_point_optimized(time_difference_hours, pv_power_values, power_usage_values, offtake_price_values, injection_price_values, soc_value, battery)
