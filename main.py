...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.sidebar_button_1 = customtkinter.CTkButton(
            self.sidebar_frame, width=150, text="Start Simulation", command=self.verify_parameters
        )
        ...
        self.sidebar_button_2 = customtkinter.CTkButton(
            self.sidebar_frame, width=150, text="Simulation Parameters", command=self.simulation_parameters
        )
        ...
        self.label_algo = customtkinter.CTkLabel(
            self.sidebar_frame, text="Algo:", font=customtkinter.CTkFont(size=20, weight="bold")
        )
        ...
        self.label_scale = customtkinter.CTkLabel(
            self.sidebar_frame, text="Visual:", font=customtkinter.CTkFont(size=20, weight="bold")
        )
        ...
        self.optionmenu_scale = customtkinter.CTkOptionMenu(
            ...
            values=["PER YEAR", "PER MONTH", "PER WEEK", "SPECIFIC MONTH", "SPECIFIC WEEK", "SPECIFIC DAY"],
        ...
        self.optionmenu_day = customtkinter.CTkOptionMenu(
            self.sidebar_frame, width=60, command=self.option_menu_time_event
        )
        self.optionmenu_day.grid(row=1, column=4, padx=(20, 0), pady=(0, 10))

        self.optionmenu_month = customtkinter.CTkOptionMenu(
            self.sidebar_frame, width=80, command=self.option_menu_month_event
        )
        ...
        # Add logos
        self.image_uhasselt = customtkinter.CTkImage(
            dark_image=Image.open(os.path.join("images/uhasselt.png")), size=(120 * 1.2, 28.5 * 1.2)
        )
        ...
        self.image_uhasselt = customtkinter.CTkImage(
            dark_image=Image.open(os.path.join("images/kuleuven.png")), size=(79.36 * 1.2, 28.644 * 1.2)
        )
        label_uhasselt = customtkinter.CTkLabel(self.sidebar_frame, image=self.image_uhasselt, text="")
        label_uhasselt.grid(row=0, column=7, rowspan=2, padx=(20, 0), sticky="e")

        self.image_ilumen = customtkinter.CTkImage(
            dark_image=Image.open(os.path.join("images/ilumen.png")), size=(101.36 * 1.2, 40.88 * 1.2)
        )
        ...
        self.fig, (self.ax1, self.ax2, self.ax3) = plt.subplots(3, 1, figsize=(13, 8), gridspec_kw={"height_ratios": [2, 2, 2]})
        self.ax4 = 0
        ...
        # Create second sidebar frame with widgets
        ...
        self.logo_label1 = customtkinter.CTkLabel(
            self.sidebar_frame2, text="Simulation Results", font=customtkinter.CTkFont(size=20, weight="bold")
        )
        self.logo_label1.grid(row=0, column=0, pady=(20, 20), columnspan=3)

        self.logo_label2 = customtkinter.CTkLabel(
            self.sidebar_frame2, text="Algo 1", font=customtkinter.CTkFont(size=15)
        )
        self.logo_label2.grid(row=1, column=1, padx=(0, 10))

        self.logo_label3 = customtkinter.CTkLabel(
            self.sidebar_frame2, text="Algo 2", font=customtkinter.CTkFont(size=15)
        )
        ...
        self.label_pv_production = customtkinter.CTkLabel(
            self.sidebar_frame2, text="Total Pv Production:", anchor="w", font=customtkinter.CTkFont(size=15)
        )
        ...
        self.label_power_use = customtkinter.CTkLabel(
            self.sidebar_frame2, text="Total Power Use:", anchor="w", font=customtkinter.CTkFont(size=15)
        )
        ...
        self.label_heat_pump_usage = customtkinter.CTkLabel(
            self.sidebar_frame2, text="Total Heat Pump Usage:", anchor="w", font=customtkinter.CTkFont(size=15)
        )
        ...
        self.label_ev_charge = customtkinter.CTkLabel(
            self.sidebar_frame2, text="Total Ev Charge:", anchor="w", font=customtkinter.CTkFont(size=15)
        )
        ...
        self.label_charge = customtkinter.CTkLabel(
            self.sidebar_frame2, text="Total Bat. Charge:", anchor="w", font=customtkinter.CTkFont(size=15)
        )
        ...
        self.label_discharge = customtkinter.CTkLabel(
            self.sidebar_frame2, text="Total Bat. Discharge:", anchor="w", font=customtkinter.CTkFont(size=15)
        )
        ...
        self.label_offtake = customtkinter.CTkLabel(
            self.sidebar_frame2, text="Total Grid Offtake:", font=customtkinter.CTkFont(size=15)
        )
        ...
        self.label_injection = customtkinter.CTkLabel(
            self.sidebar_frame2, text="Total Grid Injection:", font=customtkinter.CTkFont(size=15)
        )
        ...
        self.label_cost = customtkinter.CTkLabel(
            self.sidebar_frame2, text="Total Price Offtake:", anchor="w", font=customtkinter.CTkFont(size=15)
        )
        ...
        self.label_earning = customtkinter.CTkLabel(
            self.sidebar_frame2, text="Total Price Injection:", anchor="w", font=customtkinter.CTkFont(size=15)
        )
        ...
        self.label_battery_use = customtkinter.CTkLabel(
            self.sidebar_frame2, text="Total Price Batt. Use:", anchor="w", font=customtkinter.CTkFont(size=15)
        )
        ...
        self.label_price = customtkinter.CTkLabel(
            self.sidebar_frame2, text="Net Price:", anchor="w", font=customtkinter.CTkFont(size=15)
        )
        ...
        self.label_saved = customtkinter.CTkLabel(
            self.sidebar_frame2, text="Difference:", anchor="w", font=customtkinter.CTkFont(size=15, weight="bold")
        )
    ...
    def update_graphs_with_new_data(self, data_points, data_points_algo_2):
        ...
        # Calculate values for the first algorithm
        calculated_values = calculate_values(
            data_points, str(self.optionmenu_day.get()) + "-" + str(self.optionmenu_month.get()), self.optionmenu_scale.get()
        )
        ...
        # Update text labels with calculated values
        ...
        self.label_price_result_1.configure(
            text="€" + str(round(abs(grid_offtake_cost) - abs(grid_injection_cost), 2))
        )

        # Calculate bottom values for stacking bars
        ...
        # Plot data for the first algorithm
        ...
        self.ax1.bar(time_values, discharge_values, bottom=pv_power_values, color="#FF0000", label="Bat. Discharge", width=line_width)
        self.ax1.bar(time_values, grid_offtake_values, bottom=bottom_offtake, color="b", label="Grid Offtake", width=line_width)
        self.ax1.bar(time_values, power_usage_values, color="#808080", label="Power Usage", width=line_width)
        self.ax1.bar(time_values, heat_pump_values, bottom=power_usage_values, color="#CCFF00", label="Heat Pump Usage", width=line_width)
        self.ax1.bar(time_values, ev_charge_values, bottom=bottom_ev, color="#add8e6", label="Ev Charge", width=line_width)
        self.ax1.bar(time_values, charge_values, bottom=bottom_charge, color="#009600", label="Bat. Charge", width=line_width)
        self.ax1.bar(time_values, grid_injection_values, bottom=bottom_injection, color="#4C00A4", label="Grid Injection", width=line_width)
        ...
        # Calculate values for the second algorithm
        calculated_values_algo_2 = calculate_values(
            data_points_algo_2, str(self.optionmenu_day.get()) + "-" + str(self.optionmenu_month.get()), self.optionmenu_scale.get()
        )

        # Extract calculated values for the second algorithm
        ...
        # Update text labels with calculated values for the second algorithm
        ...
        self.label_price_result_2.configure(
            text="€" + str(round(abs(grid_offtake_cost_algo_2) - abs(grid_injection_cost_algo_2), 2))
        )

        # Calculate bottom values for stacking bars for the second algorithm
        ...
        # Plot data for the second algorithm
        ...
        self.ax2.bar(time_values_algo_2, pv_power_values_algo_2, color="#FFA500", label="PV Power", width=line_width_algo_2)
        self.ax2.bar(time_values_algo_2, discharge_values_algo_2, bottom=pv_power_values_algo_2, color="#FF0000", label="Discharge", width=line_width_algo_2)
        self.ax2.bar(time_values_algo_2, grid_offtake_values_algo_2, bottom=bottom_offtake_algo_2, color="b", label="Grid Offtake", width=line_width_algo_2)
        self.ax2.bar(time_values_algo_2, power_usage_values_algo_2, color="#808080", label="Power Usage", width=line_width_algo_2)
        self.ax2.bar(time_values_algo_2, heat_pump_values_algo_2, bottom=power_usage_values_algo_2, color="#CCFF00", label="Heat Pump usage", width=line_width)
        self.ax2.bar(time_values_algo_2, ev_charge_values_algo_2, bottom=bottom_ev_algo_2, color="#add8e6", label="Ev Charge", width=line_width)
        self.ax2.bar(time_values_algo_2, charge_values_algo_2, bottom=bottom_charge_algo_2, color="#009600", label="Bat. Charge", width=line_width)
        self.ax2.bar(time_values_algo_2, grid_injection_values_algo_2, bottom=bottom_injection_algo_2, color="#4C00A4", label="Grid Injection", width=line_width_algo_2)
        ...
        # Calculate savings and update label
        saving = round(
            (abs(grid_offtake_cost) - abs(grid_injection_cost)) - (abs(grid_offtake_cost_algo_2) - abs(grid_injection_cost_algo_2)),
            2
        )
        ...
        # Scale and plot SOC values and grid prices
        ...
        # Plot SOC values on secondary y-axis
        ax4 = self.ax3.twinx()
        removed = False
        ax4.clear()
        ax4.set_ylabel("SOC", color="g", labelpad=15)
        ax4.yaxis.set_label_coords(1.055, 0.5)
    ...
    def update_date_options(self, event):
        # Update date options based on selected scale
        selected_scale = self.optionmenu_scale.get()
        time_options = True

        if selected_scale in ["SPECIFIC MONTH", "SPECIFIC WEEK", "SPECIFIC DAY"]:
            time_options = True
        else:
            time_options = False
            self.optionmenu_day.configure(fg_color="grey20", button_color="grey20", state="disabled")
        ...
        if time_options:
            ...
            if self.optionmenu_day.get() not in [str(val) for val in range(1, 32)]:
                self.optionmenu_day.set(1)
            if self.optionmenu_month.get() not in [
                "January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"
            ]:
                self.optionmenu_month.set("January")
    ...
    def verify_parameters(self):
        ...
        try:
            ...
            if self.simulation_data:
                ...
                self.battery_opex = (
                    int(str(self.simulation_data[7]).split("12345")[1]) * 1000 / (
                    int(str(self.simulation_data[7]).split("12345")[0]) * self.simulation_data[5])
                ) if self.simulation_data[5] != 0 else 1
            ...
            # Show warning message if parameters are not set
            CTkMessagebox(title="Warning Message!", message="Please Select Simulation Parameters", icon="warning", option_1="OK")
            return
    ...
    def start_process(self):
        ...
        battery_home_1 = Battery(
            capacity=self.battery_capacity, soc=0, charge_power=self.battery_charge, discharge_power=self.battery_discharge,
            max_soc=0.95, min_dod=0.05, efficiency=self.battery_efficiency
        )

        battery_car_1 = Battery(
            capacity=40, soc=38, charge_power=self.ev_charge, discharge_power=100, max_soc=0.95, min_dod=0.05, efficiency=self.ev_efficiency
        )
        ...
        # Process data points
        data_points = process_solar_data(
            self.general_latitude, self.general_longitude, self.general_start_date, self.solar_number_of_panels,
            self.solar_width * self.solar_length, self.solar_azimuth, self.solar_tilt, self.solar_efficiency,
        ...
        data_points_algo_2 = copy.deepcopy(data_points)

        self.data_points_complete_algo_1 = process_data_points(
            self.optionmenu_algo_1.get(), data_points, battery_home_1, battery_car_1,
            self.ev_distance_year * self.ev_number_of_cars, self.battery_opex, self.heat_temp
        )

        self.data_points_complete_algo_2 = process_data_points(
            self.optionmenu_algo_2.get(), data_points_algo_2, battery_home_2, battery_car_2,
            self.ev_distance_year * self.ev_number_of_cars, self.battery_opex, self.heat_temp
        )
