...
from process import (calculate_values, get_ev_charge_values, get_power_usage_values, process_data_points, scale_list, )
...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.sidebar_frame = customtkinter.CTkFrame(self, corner_radius=0, border_width=2)
        ...
        self.sidebar_button_1 = customtkinter.CTkButton(self.sidebar_frame, width=150, text="Start Simulation",
                                                        command=self.verify_parameters, )
        self.sidebar_button_1.grid(row=0, column=0, pady=(10, 5), padx=(20, 20))

        ######################################################

        self.sidebar_button_2 = customtkinter.CTkButton(self.sidebar_frame, width=150, text="Simulation Parameters",
        ...
        self.label_algo = customtkinter.CTkLabel(self.sidebar_frame, text="Algo:",
                                                 font=customtkinter.CTkFont(size=20, weight="bold"), )
        self.label_algo.grid(row=0, column=1, rowspan=2, padx=(40, 0))

        self.optionmenu_algo_1 = customtkinter.CTkOptionMenu(self.sidebar_frame, )
        self.optionmenu_algo_1.grid(row=0, column=2, padx=(20, 20), pady=(10, 5))

        self.optionmenu_algo_2 = customtkinter.CTkOptionMenu(self.sidebar_frame, )
        ...
        self.label_scale = customtkinter.CTkLabel(self.sidebar_frame, text="Visual:",
                                                  font=customtkinter.CTkFont(size=20, weight="bold"), )
        ...
        self.optionmenu_scale = customtkinter.CTkOptionMenu(self.sidebar_frame, dynamic_resizing=False,
                                                            values=["PER YEAR", "PER MONTH", "PER WEEK",
        ...
        self.optionmenu_day = customtkinter.CTkOptionMenu(self.sidebar_frame, width=60,
                                                          command=self.option_menu_time_event)
        self.optionmenu_day.grid(row=1, column=4, padx=(20, 0), pady=(0, 10))

        self.optionmenu_month = customtkinter.CTkOptionMenu(self.sidebar_frame, width=80,
                                                            command=self.option_menu_month_event)
        self.optionmenu_month.grid(row=1, column=5, padx=(5, 0), pady=(0, 10))

        #######################################################

        self.image_uhasselt = customtkinter.CTkImage(dark_image=Image.open(os.path.join("images/uhasselt.png")),
                                                     size=(120 * 1.2, 28.5 * 1.2))
        ...
        self.image_uhasselt = customtkinter.CTkImage(dark_image=Image.open(os.path.join("images/kuleuven.png")),
                                                     size=(79.36 * 1.2, 28.644 * 1.))
        label_uhasselt = customtkinter.CTkLabel(self.sidebar_frame, image=self.image_uhasselt, text='')
        label_uhasselt.grid(row=0, column=7, rowspan=2, padx=(20, 0), sticky="e")

        self.image_ilumen = customtkinter.CTkImage(dark_image=Image.open(os.path.join("images/ilumen.png")),
                                                   size=(101.36 * 1.2, 40.88 * 1.2))
        ...
        self.fig, (self.ax1, self.ax2, self.ax3) = plt.subplots(3, 1, figsize=(13, 8),
        ...
        self.canvas1.get_tk_widget().grid(row=1, column=0, sticky="w")
        ...
        self.logo_label1 = customtkinter.CTkLabel(self.sidebar_frame2, text="Simulation Results",
                                                  font=customtkinter.CTkFont(size=20, weight="bold"), )
        self.logo_label1.grid(row=0, column=0, pady=(20, 20), columnspan=3)

        self.logo_label2 = customtkinter.CTkLabel(self.sidebar_frame2, text="Algo 1",
                                                  font=customtkinter.CTkFont(size=15), )
        self.logo_label2.grid(row=1, column=1, padx=(0, 10))

        self.logo_label3 = customtkinter.CTkLabel(self.sidebar_frame2, text="Algo 2",
                                                  font=customtkinter.CTkFont(size=15), )
        self.logo_label3.grid(row=1, column=2, padx=(0, 20))

        ###########################################################

        self.label_pv_production = customtkinter.CTkLabel(self.sidebar_frame2, text="Total Pv Production:", anchor="w",
                                                          font=customtkinter.CTkFont(size=15), )
        self.label_pv_production.grid(row=2, column=0, padx=20, pady=(5, 0), sticky="w")

        self.label_pv_production_result_1 = customtkinter.CTkLabel(self.sidebar_frame2, text="...",
                                                                   font=customtkinter.CTkFont(size=12))
        self.label_pv_production_result_1.grid(row=2, column=1, columnspan=2, pady=(5, 0), padx=(0, 10))

        ###########################################################

        self.label_power_use = customtkinter.CTkLabel(self.sidebar_frame2, text="Total Power Use:", anchor="w",
                                                      font=customtkinter.CTkFont(size=15), )
        self.label_power_use.grid(row=3, column=0, padx=20, pady=(0, 0), sticky="w")

        self.label_power_use_result_1 = customtkinter.CTkLabel(self.sidebar_frame2, text="...",
                                                               font=customtkinter.CTkFont(size=12))
        self.label_power_use_result_1.grid(row=3, column=1, columnspan=2, pady=(0, 0), padx=(0, 10))

        ###########################################################

        self.label_heat_pump_usage = customtkinter.CTkLabel(self.sidebar_frame2, text="Total Heat Pump Usage:",
                                                            anchor="w", font=customtkinter.CTkFont(size=15), )
        self.label_heat_pump_usage.grid(row=4, column=0, padx=20, pady=(0, 0), sticky="w")

        self.label_heat_pump_usage_result_1 = customtkinter.CTkLabel(self.sidebar_frame2, text="...",
                                                                     font=customtkinter.CTkFont(size=12))
        self.label_heat_pump_usage_result_1.grid(row=4, column=1, columnspan=2, pady=(0, 0), padx=(0, 10))

        ###########################################################

        self.label_ev_charge = customtkinter.CTkLabel(self.sidebar_frame2, text="Total Ev Charge:", anchor="w",
                                                      font=customtkinter.CTkFont(size=15), )
        self.label_ev_charge.grid(row=5, column=0, padx=20, pady=(0, 0), sticky="w")

        self.label_ev_charge_result_1 = customtkinter.CTkLabel(self.sidebar_frame2, text="...",
                                                               font=customtkinter.CTkFont(size=12))
        self.label_ev_charge_result_1.grid(row=5, column=1, columnspan=2, pady=(0, 0), padx=(0, 10))

        ###########################################################

        self.label_charge = customtkinter.CTkLabel(self.sidebar_frame2, text="Total Bat. Charge:", anchor="w",
                                                   font=customtkinter.CTkFont(size=15), )
        self.label_charge.grid(row=6, column=0, padx=20, pady=(15, 0), sticky="w")

        self.label_charge_result_1 = customtkinter.CTkLabel(self.sidebar_frame2, text="...",
                                                            font=customtkinter.CTkFont(size=12))
        self.label_charge_result_1.grid(row=6, column=1, pady=(15, 0), padx=(0, 10))

        self.label_charge_result_2 = customtkinter.CTkLabel(self.sidebar_frame2, text="...",
                                                            font=customtkinter.CTkFont(size=12))
        self.label_charge_result_2.grid(row=6, column=2, pady=(15, 0), padx=(0, 20))

        ###########################################################

        self.label_discharge = customtkinter.CTkLabel(self.sidebar_frame2, text="Total Bat. Discharge:", anchor="w",
                                                      font=customtkinter.CTkFont(size=15), )
        self.label_discharge.grid(row=7, column=0, padx=20, pady=(0, 0), sticky="w")

        self.label_discharge_result_1 = customtkinter.CTkLabel(self.sidebar_frame2, text="...",
                                                               font=customtkinter.CTkFont(size=12))
        self.label_discharge_result_1.grid(row=7, column=1, pady=(0, 0), padx=(0, 10))

        self.label_discharge_result_2 = customtkinter.CTkLabel(self.sidebar_frame2, text="...",
                                                               font=customtkinter.CTkFont(size=12))
        self.label_discharge_result_2.grid(row=7, column=2, pady=(0, 0), padx=(0, 20))

        ############################################################

        self.label_offtake = customtkinter.CTkLabel(self.sidebar_frame2, text="Total Grid Offtake:",
                                                    font=customtkinter.CTkFont(size=15), )
        self.label_offtake.grid(row=8, column=0, padx=20, pady=(15, 0), sticky="w")

        self.label_offtake_result_1 = customtkinter.CTkLabel(self.sidebar_frame2, text="...",
                                                             font=customtkinter.CTkFont(size=12))
        self.label_offtake_result_1.grid(row=8, column=1, pady=(15, 0), padx=(0, 10))

        self.label_offtake_result_2 = customtkinter.CTkLabel(self.sidebar_frame2, text="...",
                                                             font=customtkinter.CTkFont(size=12))
        self.label_offtake_result_2.grid(row=8, column=2, pady=(15, 0), padx=(0, 20))

        ############################################################

        self.label_injection = customtkinter.CTkLabel(self.sidebar_frame2, text="Total Grid Injection:",
                                                      font=customtkinter.CTkFont(size=15), )
        self.label_injection.grid(row=9, column=0, padx=20, pady=(0, 0), sticky="w")

        self.label_injection_result_1 = customtkinter.CTkLabel(self.sidebar_frame2, text="...",
                                                               font=customtkinter.CTkFont(size=12))
        self.label_injection_result_1.grid(row=9, column=1, pady=(0, 0), padx=(0, 10))

        self.label_injection_result_2 = customtkinter.CTkLabel(self.sidebar_frame2, text="...",
                                                               font=customtkinter.CTkFont(size=12))
        self.label_injection_result_2.grid(row=9, column=2, pady=(0, 0), padx=(0, 20))

        ###########################################################

        self.label_cost = customtkinter.CTkLabel(self.sidebar_frame2, text="Total Price Offtake:", anchor="w",
                                                 font=customtkinter.CTkFont(size=15), )
        self.label_cost.grid(row=10, column=0, padx=20, pady=(15, 0), sticky="w")

        self.label_cost_result_1 = customtkinter.CTkLabel(self.sidebar_frame2, text="...",
                                                          font=customtkinter.CTkFont(size=12))
        self.label_cost_result_1.grid(row=10, column=1, pady=(15, 0), padx=(0, 10))

        self.label_cost_result_2 = customtkinter.CTkLabel(self.sidebar_frame2, text="...",
                                                          font=customtkinter.CTkFont(size=12))
        self.label_cost_result_2.grid(row=10, column=2, pady=(15, 0), padx=(0, 20))

        ###########################################################

        self.label_earning = customtkinter.CTkLabel(self.sidebar_frame2, text="Total Price Injection:", anchor="w",
                                                    font=customtkinter.CTkFont(size=15), )
        self.label_earning.grid(row=11, column=0, padx=20, pady=(0, 0), sticky="w")

        self.label_earning_result_1 = customtkinter.CTkLabel(self.sidebar_frame2, text="...",
                                                             font=customtkinter.CTkFont(size=12))
        self.label_earning_result_1.grid(row=11, column=1, pady=(0, 0), padx=(0, 10))

        self.label_earning_result_2 = customtkinter.CTkLabel(self.sidebar_frame2, text="...",
                                                             font=customtkinter.CTkFont(size=12))
        self.label_earning_result_2.grid(row=11, column=2, pady=(0, 0), padx=(0, 20))

        ###########################################################

        self.label_battery_use = customtkinter.CTkLabel(self.sidebar_frame2, text="Total Price Batt. Use:", anchor="w",
                                                        font=customtkinter.CTkFont(size=15), )
        self.label_battery_use.grid(row=12, column=0, padx=20, pady=(0, 0), sticky="w")

        self.label_battery_use_result_1 = customtkinter.CTkLabel(self.sidebar_frame2, text="...",
                                                                 font=customtkinter.CTkFont(size=12))
        self.label_battery_use_result_1.grid(row=12, column=1, pady=(0, 0), padx=(0, 10))

        self.label_battery_use_result_2 = customtkinter.CTkLabel(self.sidebar_frame2, text="...",
                                                                 font=customtkinter.CTkFont(size=12))
        self.label_battery_use_result_2.grid(row=12, column=2, pady=(0, 0), padx=(0, 20))

        ###########################################################

        self.label_price = customtkinter.CTkLabel(self.sidebar_frame2, text="Net Price:", anchor="w",
                                                  font=customtkinter.CTkFont(size=15), )
        self.label_price.grid(row=13, column=0, padx=20, pady=(15, 0), sticky="w")

        self.label_price_result_1 = customtkinter.CTkLabel(self.sidebar_frame2, text="...",
                                                           font=customtkinter.CTkFont(size=12))
        self.label_price_result_1.grid(row=13, column=1, pady=(15, 0), padx=(0, 10))

        self.label_price_result_2 = customtkinter.CTkLabel(self.sidebar_frame2, text="...",
                                                           font=customtkinter.CTkFont(size=12))
        self.label_price_result_2.grid(row=13, column=2, pady=(15, 0), padx=(0, 20))

        ########################################################### 

        self.label_saved = customtkinter.CTkLabel(self.sidebar_frame2, text="Difference:", anchor="w",
                                                  font=customtkinter.CTkFont(size=15, weight='bold'), )
        self.label_saved.grid(row=14, column=0, padx=20, pady=(15, 0), sticky="w")

        self.label_saved_result_1 = customtkinter.CTkLabel(self.sidebar_frame2, text="...",
    ...
    def update_graphs_with_new_data(self, data_points, data_points_algo_2):
        ...
        calculated_values = calculate_values(data_points,
                                             str(self.optionmenu_day.get()) + "-" + str(self.optionmenu_month.get()),
                                             self.optionmenu_scale.get())
        ...
        self.label_price_result_1.configure(text="€" + str(round(abs(grid_offtake_cost) - abs(grid_injection_cost), 2))) #text="€" + str(round(abs(grid_offtake_cost) - abs(grid_injection_cost) + abs(battery_use_cost), 2))
        ...
        bottom_injection = [x + y + z + a for x, y, z, a in
                            zip(power_usage_values, heat_pump_values, ev_charge_values, charge_values)]
        ...
        self.ax1.bar(time_values, pv_power_values, color="#FFA500", label="PV Power", width=line_width)
        self.ax1.bar(time_values, discharge_values, bottom=pv_power_values, color="#FF0000", label="Bat. Discharge",
                     width=line_width, )
        self.ax1.bar(time_values, grid_offtake_values, bottom=bottom_offtake, color="b", label="Grid Offtake",
                     width=line_width, )

        self.ax1.bar(time_values, power_usage_values, color="#808080", label="Power Usage", width=line_width)
        self.ax1.bar(time_values, heat_pump_values, bottom=power_usage_values, color="#CCFF00", label="Heat Pump Usage",
                     width=line_width)
        self.ax1.bar(time_values, ev_charge_values, bottom=bottom_ev, color="#add8e6", label="Ev Charge",
                     width=line_width)
        self.ax1.bar(time_values, charge_values, bottom=bottom_charge, color="#009600", label="Bat. Charge",
                     width=line_width, )
        self.ax1.bar(time_values, grid_injection_values, bottom=bottom_injection, color="#4C00A4",
                     label="Grid Injection", width=line_width, )
        ...
        calculated_values_algo_2 = calculate_values(data_points_algo_2, str(self.optionmenu_day.get()) + "-" + str(
            self.optionmenu_month.get()), self.optionmenu_scale.get())
        ...
        self.label_price_result_2.configure(text="€" + str(round(abs(grid_offtake_cost_algo_2) - abs(grid_injection_cost_algo_2), 2)))  #text="€" + str(round(abs(grid_offtake_cost_algo_2) - abs(grid_injection_cost_algo_2) + abs(battery_use_cost_algo_2), 2))
        ...
        bottom_charge_algo_2 = [x + y + z for x, y, z in
                                zip(power_usage_values_algo_2, heat_pump_values_algo_2, ev_charge_values_algo_2)]
        bottom_injection_algo_2 = [x + y + z + a for x, y, z, a in
                                   zip(power_usage_values_algo_2, heat_pump_values_algo_2, ev_charge_values_algo_2,
        ...
        self.ax2.bar(time_values_algo_2, pv_power_values_algo_2, color="#FFA500", label="PV Power",
                     width=line_width_algo_2)
        self.ax2.bar(time_values_algo_2, discharge_values_algo_2, bottom=pv_power_values_algo_2, color="#FF0000",
                     label="Discharge", width=line_width_algo_2, )
        self.ax2.bar(time_values_algo_2, grid_offtake_values_algo_2, bottom=bottom_offtake_algo_2, color="b",
                     label="Grid Offtake", width=line_width_algo_2, )

        self.ax2.bar(time_values_algo_2, power_usage_values_algo_2, color="#808080", label="Power Usage",
                     width=line_width_algo_2)
        self.ax2.bar(time_values_algo_2, heat_pump_values_algo_2, bottom=power_usage_values_algo_2, color="#CCFF00",
                     label="Heat Pump usage", width=line_width)
        self.ax2.bar(time_values_algo_2, ev_charge_values_algo_2, bottom=bottom_ev_algo_2, color="#add8e6",
                     label="Ev Charge", width=line_width)
        self.ax2.bar(time_values_algo_2, charge_values_algo_2, bottom=bottom_charge_algo_2, color="#009600",
                     label="Bat. Charge", width=line_width, )
        self.ax2.bar(time_values_algo_2, grid_injection_values_algo_2, bottom=bottom_injection_algo_2, color="#4C00A4",
                     label="Grid Injection", width=line_width_algo_2, )
        ...
        ############################################################################
        ############################################################################
        saving = round((abs(grid_offtake_cost) - abs(grid_injection_cost)) - (
                abs(grid_offtake_cost_algo_2) - abs(grid_injection_cost_algo_2)), 2)
        saving_percentage = round(
            saving / abs(abs(grid_offtake_cost) - abs(grid_injection_cost)), 2) * 100
        self.label_saved_result_1.configure(text="€" + str(saving) + "\n  " + str(round(saving_percentage, 2)) + "%")
        
        #with battery cost:
        # saving = round((abs(grid_offtake_cost) - abs(grid_injection_cost) + abs(battery_use_cost)) - (
        #         abs(grid_offtake_cost_algo_2) - abs(grid_injection_cost_algo_2) + abs(battery_use_cost_algo_2)), 2)
        # saving_percentage = round(
        #     saving / abs(abs(grid_offtake_cost) - abs(grid_injection_cost) + abs(battery_use_cost)), 2) * 100
        # self.label_saved_result_1.configure(text="€" + str(saving) + "\n  " + str(round(saving_percentage, 2)) + "%")
    ...
    def update_date_options(self, event):
        ...
        if selected_scale == "SPECIFIC MONTH":
            ...
            time_options = True  # for month in range(1, 13):  #     for day in range(1, 32):  #         try:  #             date = datetime.date(2023, month, day)  #             time_options.append((date.strftime("%d-%m")))  #         except ValueError:  #             # Handle cases where the day is out of range for the month  #             pass
        else:
            time_options = False
            self.optionmenu_day.configure(fg_color="grey20", button_color="grey20", state="disabled")
            self.optionmenu_month.configure(fg_color="grey20", button_color="grey20", state="disabled")
        ...
        if time_options:
            ...
            self.optionmenu_month.configure(
            ...
            if self.optionmenu_month.get() not in ["January", "February", "March", "April", "May", "June", "July",
                                                   "August", "September", "October", "November",
                                                   "December"]: self.optionmenu_month.set("January")
    ...
    def option_menu_month_event(self, event):
        ...
        days_in_month = {"January": 31, "February": 28,  # Assuming it's not a leap year
    ...
    def verify_parameters(self):
        try:
            ...
            if self.simulation_data:
                ...
                self.battery_opex = (int(str(self.simulation_data[7]).split("12345")[1]) * 1000 / (
                        int(str(self.simulation_data[7]).split("12345")[0]) * self.simulation_data[5])) if \
                    self.simulation_data[5] != 0 else 1
            ...
            CTkMessagebox(title="Warning Message!", message="Please Select Simulation Parameters", icon="warning",
                          option_1="OK")
            return
    ...
    def start_process(self):
        ...
        battery_home_1 = Battery(capacity=self.battery_capacity, soc=0, charge_power=self.battery_charge,
                                 discharge_power=self.battery_discharge, max_soc=0.95, min_dod=0.05,
                                 efficiency=self.battery_efficiency, )

        battery_car_1 = Battery(capacity=40, soc=38, charge_power=self.ev_charge, discharge_power=100, max_soc=0.95,
                                min_dod=0.05, efficiency=self.ev_efficiency, )
        ...
        data_points = process_solar_data(self.general_latitude, self.general_longitude, self.general_start_date,
                                         self.solar_number_of_panels, self.solar_width * self.solar_length,
                                         self.solar_azimuth, self.solar_tilt, self.solar_efficiency,
                                         self.solar_efficiency, self.solar_cap, self.solar_inv_cap, self.use_api)
        ...
        data_points = process_heat_pump_data(data_points, self.heat_area, self.heat_cop, self.heat_temp,
                                             self.heat_certificate)
