...
class SimulationDialog(customtkinter.CTk):
    def __init__(self, db_manager):
        ...
        self.checkbox_testing = customtkinter.CTkCheckBox(self.frame_3, text="Use Testing Data", onvalue="on",
                                                          offvalue="off")
    ...
    def switch_battery_event(self):
        if self.switch_battery.get() == 0:
            self.optionmenu_battery.configure(fg_color="grey17", button_color="grey17", text_color_disabled="grey17",
                                              state="disabled")
            self.entry_battery_charge.configure(fg_color="grey17", border_color="grey17", text_color="grey17",
                                                state="disabled")
            self.label_battery_charge.configure(text_color='grey17')
            self.entry_battery_discharge.configure(fg_color="grey17", border_color="grey17", text_color="grey17",
                                                   state="disabled")
            self.label_battery_discharge.configure(text_color='grey17')
            self.entry_battery_capacity.configure(fg_color="grey17", border_color="grey17", text_color="grey17",
                                                  state="disabled")
            self.label_battery_capacity.configure(text_color='grey17')
            self.entry_battery_efficiency.configure(fg_color="grey17", border_color="grey17", text_color="grey17",
                                                    state="disabled")
            self.label_battery_efficiency.configure(text_color='grey17')
            self.entry_battery_cycle_life.configure(fg_color="grey17", border_color="grey17", text_color="grey17",
                                                    state="disabled")
            self.label_battery_cycle_life.configure(text_color='grey17')
            self.entry_battery_price.configure(fg_color="grey17", border_color="grey17", text_color="grey17",
                                               state="disabled")
        ...
        if self.switch_battery.get() == 1:
            ...
            self.entry_battery_charge.configure(state="normal", fg_color="#343638", text_color="#DCE4EE",
                                                border_color="#565B5E")
            self.label_battery_discharge.configure(text_color='#DCE4EE')
            self.entry_battery_discharge.configure(state="normal", fg_color="#343638", text_color="#DCE4EE",
                                                   border_color="#565B5E")
            self.label_battery_capacity.configure(text_color='#DCE4EE')
            self.entry_battery_capacity.configure(state="normal", fg_color="#343638", text_color="#DCE4EE",
                                                  border_color="#565B5E")
            self.label_battery_efficiency.configure(text_color='#DCE4EE')
            self.entry_battery_efficiency.configure(state="normal", fg_color="#343638", text_color="#DCE4EE",
                                                    border_color="#565B5E")
            self.label_battery_cycle_life.configure(text_color='#DCE4EE')
            self.entry_battery_cycle_life.configure(state="normal", fg_color="#343638", text_color="#DCE4EE",
                                                    border_color="#565B5E")
            self.label_battery_price.configure(text_color='#DCE4EE')
            self.entry_battery_price.configure(state="normal", fg_color="#343638", text_color="#DCE4EE",
                                               border_color="#565B5E")
    ...
    def switch_solar_event(self):
        if self.switch_solar.get() == 0:
            self.optionmenu_solar_panel.configure(fg_color="grey17", button_color="grey17",
                                                  text_color_disabled="grey17", state="disabled")
            self.entry_solar_azimuth.configure(fg_color="grey17", border_color="grey17", text_color="grey17",
                                               state="disabled")
            self.label_solar_azimuth.configure(text_color='grey17')
            self.entry_solar_tilt.configure(fg_color="grey17", border_color="grey17", text_color="grey17",
                                            state="disabled")
            self.label_solar_tilt.configure(text_color='grey17')
            self.entry_solar_number_of_panels.configure(fg_color="grey17", border_color="grey17", text_color="grey17",
                                                        state="disabled")
            self.label_solar_number_of_panels.configure(text_color='grey17')
            self.entry_solar_efficiency.configure(fg_color="grey17", border_color="grey17", text_color="grey17",
                                                  state="disabled")
            self.label_solar_efficiency.configure(text_color='grey17')
            self.entry_solar_length.configure(fg_color="grey17", border_color="grey17", text_color="grey17",
                                              state="disabled")
            self.label_solar_length.configure(text_color='grey17')
            self.entry_solar_width.configure(fg_color="grey17", border_color="grey17", text_color="grey17",
                                             state="disabled")
            self.label_solar_width.configure(text_color='grey17')
            self.entry_solar_cap.configure(fg_color="grey17", border_color="grey17", text_color="grey17",
                                           state="disabled")
            self.label_solar_cap.configure(text_color='grey17')
            self.entry_solar_inv_cap.configure(fg_color="grey17", border_color="grey17", text_color="grey17",
                                               state="disabled")
        ...
        if self.switch_solar.get() == 1:
            ...
            self.entry_solar_azimuth.configure(state="normal", fg_color="#343638", text_color="#DCE4EE",
                                               border_color="#565B5E")
            self.label_solar_tilt.configure(text_color='#DCE4EE')
            self.entry_solar_tilt.configure(state="normal", fg_color="#343638", text_color="#DCE4EE",
                                            border_color="#565B5E")
            self.label_solar_number_of_panels.configure(text_color='#DCE4EE')
            self.entry_solar_number_of_panels.configure(state="normal", fg_color="#343638", text_color="#DCE4EE",
                                                        border_color="#565B5E")
            self.label_solar_efficiency.configure(text_color='#DCE4EE')
            self.entry_solar_efficiency.configure(state="normal", fg_color="#343638", text_color="#DCE4EE",
                                                  border_color="#565B5E")
            self.label_solar_length.configure(text_color='#DCE4EE')
            self.entry_solar_length.configure(state="normal", fg_color="#343638", text_color="#DCE4EE",
                                              border_color="#565B5E")
            self.label_solar_width.configure(text_color='#DCE4EE')
            self.entry_solar_width.configure(state="normal", fg_color="#343638", text_color="#DCE4EE",
                                             border_color="#565B5E")
            self.label_solar_cap.configure(text_color='#DCE4EE')
            self.entry_solar_cap.configure(state="normal", fg_color="#343638", text_color="#DCE4EE",
                                           border_color="#565B5E")
            self.label_solar_inv_cap.configure(text_color='#DCE4EE')
            self.entry_solar_inv_cap.configure(state="normal", fg_color="#343638", text_color="#DCE4EE",
                                               border_color="#565B5E")
    ...
    def switch_ev_event(self):
        if self.switch_ev.get() == 0:
            self.optionmenu_ev_charger.configure(fg_color="grey17", button_color="grey17", text_color_disabled="grey17",
                                                 state="disabled")
            self.entry_ev_charge.configure(fg_color="grey17", border_color="grey17", text_color="grey17",
                                           state="disabled")
            self.label_ev_charge.configure(text_color='grey17')
            self.entry_ev_number_of_cars.configure(fg_color="grey17", border_color="grey17", text_color="grey17",
                                                   state="disabled")
            self.label_ev_number_of_cars.configure(text_color='grey17')
            self.entry_ev_distance_year.configure(fg_color="grey17", border_color="grey17", text_color="grey17",
                                                  state="disabled")
            self.label_ev_distance_year.configure(text_color='grey17')
            self.entry_ev_efficiency.configure(fg_color="grey17", border_color="grey17", text_color="grey17",
                                               state="disabled")
        ...
        if self.switch_ev.get() == 1:
            ...
            self.entry_ev_charge.configure(state="normal", fg_color="#343638", text_color="#DCE4EE",
                                           border_color="#565B5E")
            self.label_ev_number_of_cars.configure(text_color='#DCE4EE')
            self.entry_ev_number_of_cars.configure(state="normal", fg_color="#343638", text_color="#DCE4EE",
                                                   border_color="#565B5E")
            self.label_ev_distance_year.configure(text_color='#DCE4EE')
            self.entry_ev_distance_year.configure(state="normal", fg_color="#343638", text_color="#DCE4EE",
                                                  border_color="#565B5E")
            self.label_ev_efficiency.configure(text_color='#DCE4EE')
            self.entry_ev_efficiency.configure(state="normal", fg_color="#343638", text_color="#DCE4EE",
                                               border_color="#565B5E")
    ...
    def switch_heat_event(self):
        if self.switch_heat.get() == 0:
            self.optionmenu_heat_pump.configure(fg_color="grey17", button_color="grey17", text_color_disabled="grey17",
                                                state="disabled")
            self.optionmenu_certificate.configure(fg_color="grey17", button_color="grey17",
                                                  text_color_disabled="grey17", state="disabled")
            self.label_heat_certificate.configure(text_color='grey17')
            self.entry_heat_area.configure(fg_color="grey17", border_color="grey17", text_color="grey17",
                                           state="disabled")
            self.label_heat_area.configure(text_color='grey17')
            self.entry_heat_cop.configure(fg_color="grey17", border_color="grey17", text_color="grey17",
                                          state="disabled")
            self.label_heat_cop.configure(text_color='grey17')
            self.entry_heat_temp.configure(fg_color="grey17", border_color="grey17", text_color="grey17",
                                           state="disabled")
            self.label_heat_temp.configure(text_color='grey17')

        if self.switch_heat.get() == 1:
            self.optionmenu_heat_pump.configure(fg_color="#AEB74F", button_color="#9fa845", text_color="black",
                                                state="normal")
            ...
            self.entry_heat_area.configure(state="normal", fg_color="#343638", text_color="#DCE4EE",
                                           border_color="#565B5E")
            self.label_heat_cop.configure(text_color='#DCE4EE')
            self.entry_heat_cop.configure(state="normal", fg_color="#343638", text_color="#DCE4EE",
                                          border_color="#565B5E")
            self.label_heat_temp.configure(text_color='#DCE4EE')
            self.entry_heat_temp.configure(state="normal", fg_color="#343638", text_color="#DCE4EE",
                                           border_color="#565B5E")
    ...
    def confirm_parameters(self, bool_save):
        ...
        entries = {
            ...
            "Battery OPEX": int(str(self.entry_battery_cycle_life.get()) + "12345" + str(
                self.entry_battery_price.get())) if self.switch_battery.get() else "1123451",
            ...
            "Start Date": standardize_date(self.entry_general_start_date.get()),
        ...
        for key, value in entries.items():
            ...
            elif key in ranges and not is_within_range(value, *ranges[key]):
        ...
        if self.switch_battery.get():
            if float(entries["Battery Charge"]) <= 0 or float(entries["Battery Discharge"]) <= 0 or float(
                    entries["Battery Capacity"]) <= 0 or float(entries["Battery Efficiency"]) <= 0 or float(
                entries["Battery OPEX"]) <= 0:
                warning_message = "Battery fields cannot be zero when Battery is selected."
                CTkMessagebox(title="Warning", message=warning_message)
                return  # Stop further processing

        if self.switch_solar.get():
            if float(entries["Solar Azimuth"]) <= 0 or float(entries["Solar Tilt"]) <= 0 or float(
                    entries["Number of Solar Panels"]) <= 0 or float(entries["Solar Efficiency"]) <= 0 or float(
                entries["Solar Length"]) <= 0 or float(entries["Solar Width"]) <= 0 or float(
                entries["Solar Cap"]) <= 0 or float(entries["Solar Inv Cap"]) <= 0:
                warning_message = "Solar fields cannot be zero when Solar is selected."
                CTkMessagebox(title="Warning", message=warning_message)
                return  # Stop further processing

        if self.switch_ev.get():
            if float(entries["EV Charge"]) <= 0 or float(entries["EV Number of Cars"]) <= 0 or float(
                    entries["EV Efficiency"]) <= 0 or float(entries["EV Distance Year"]) <= 0:
